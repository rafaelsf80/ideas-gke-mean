...
var AppComponent = /** @class */ (function () {
    function AppComponent(modalService, iniciativasService) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.iniciativasService.getAllP()];
                    case 1:
                        _a.arrIniciativas = _b.sent();
                        return [2 /*return*/];
                }
            });
        });
    ...
    AppComponent.prototype.open = function () {
        ...
        var modalRef = this.modalService.open(_formulario_formulario_component__WEBPACK_IMPORTED_MODULE_3__["FormularioComponent"]);
...
var FormularioComponent = /** @class */ (function () {
    ...
    FormularioComponent.prototype.ngOnInit = function () {
        var tituloControl = this.formulario.controls.titulo;
        tituloControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(400)).subscribe(function (value) {
            console.log(value);
        });
    };
    FormularioComponent.prototype.crearPersona = function () {
...
var IniciativasService = /** @class */ (function () {
    function IniciativasService() {
    }
    IniciativasService.prototype.getAll = function () {
        return _data_iniciativas_db__WEBPACK_IMPORTED_MODULE_2__["INICIATIVAS"];
    };
    IniciativasService.prototype.getAllP = function () {
    ...
    IniciativasService.prototype.getById = function (id) {
        // En vez de recorrer el array, uso la función find de JS
        var escritor = _data_iniciativas_db__WEBPACK_IMPORTED_MODULE_2__["INICIATIVAS"].find(function (item) {
            return item.id == id;
        });
        return escritor;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        //})
                        _a = this;
                        return [4 /*yield*/, this.usuariosService.getAllP()];
                    case 1:
                        //this.arrEscritores = this.escritoresService.getAll()
                        // this.escritoresService.getAllP().then((ESCRITORES) => {
                        //   this.arrEscritores = ESCRITORES
                        //})
                        _a.arrUsuarios = _b.sent();
                        return [2 /*return*/];
                }
            });
        });
    };
    ListaUsuariosComponent.ctorParameters = function () { return [
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.goToPage = function (ruta) {
        console.log(ruta);
...
var UsuariosService = /** @class */ (function () {
    ...
    UsuariosService.prototype.getAllP = function () {
        // let prom = new Promise((resolve, reject) => {
        //   resolve(ESCRITORES)
        // })
        // return prom
    ...
    UsuariosService.prototype.getById = function (id) {
        // En vez de recorrer el array, uso la función find de JS
        var escritor = _data_usuarios_db__WEBPACK_IMPORTED_MODULE_2__["USUARIOS"].find(function (item) {
            return item.id == id;
        });
        return escritor;
        // Abreviado: return ESCRITORES.find(item => item.id == id)
